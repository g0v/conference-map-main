...
var $mapInfo, $Room, $updateRoom, $displayRoom, replace$ = ''.replace;
$mapInfo = {
  roomArray: []
};
$Room = (function(){
...
$displayRoom = function(){
  var windowWidth, i, i$, ref$, len$, room, nodeId, each_width, each_height, rooms_div_padding, top, left, width, height, zIndex, roomStyle, str, innerNode, node;
  log('display-room');
